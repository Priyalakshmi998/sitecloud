...
import { loadModules } from 'esri-loader'; // load the ArcGIS Component
    ...
    useEffect(
        () => {
            ...
            loadModules([
                ...
                // 
                // const samplemarker = new FeatureLayer({
                //     url: "https://services3.arcgis.com/0G16ZDbXMbWFq4Wr/arcgis/rest/services/samplemarker/FeatureServer/0",
                //     popupEnabled: true,
                //     id: "samplemarker",
                //     renderer: marker,
                //     // popupTemplate: wfirehydrantPopup
                ...
                view.when(() => {
                    ...
                    sketch.on("update", (event) => {
                        ...
                        if (event.state === "complete" && event.tool === "transform") {
                            console.log("transform", event.tool)
